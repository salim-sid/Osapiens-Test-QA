...
WebUI.click(findTestObject('Object Repository/Page_osapiens QA Portal/div_Transactions_css-1e3tf61'))

WebUI.click(findTestObject('Object Repository/Page_osapiens QA Portal/div_Hierarchy Browser_css-1e3tf61'))

WebUI.click(findTestObject('Object Repository/Page_osapiens QA Portal/div_Code Treasurer_css-1e3tf61'))
...
WebUI.click(findTestObject('Object Repository/Page_osapiens QA Portal/div_Configuration_css-1e3tf61'))
